...
- install same kernel versions in both places!
- ulimit -l should be infinity
- sudo apt-get -y install libbpf-dev
- sudo ln -s /usr/include/x86_64-linux-gnu/asm /usr/include/asm
- look at: https://github.com/iovisor/bcc/issues/3731#issuecomment-987655658
- export BCC_KERNEL_SOURCE=/usr/src/linux-headers-xxxxxxx/arch/x86
